...
const STRUCTURE_DATA: StructureCatalogEntry[] = [
  ...
  },
  {
    ...
    producedUnitId: PRODUCED_UNIT_LANTERNBOUND_LINE,
    producedPop: 3,
    localPopCap: 12,
    maxHp: 270,
    damagePerTick: 0,
  ...
  {
    id: "steelbark_motorpool",
    name: "Steelbark Motorpool",
    kind: "structure",
    fluxCost: 248,
    buildSeconds: 2,
    requiredRelayTier: 2,
    requiredSignalCounts: { Bastion: 2, Vanguard: 1 },
    signalTypes: ["Bastion", "Vanguard"],
    productionSeconds: 74,
    producedSizeClass: "Titan",
    producedPop: 1,
    localPopCap: 5,
    maxHp: 720,
    damagePerTick: 0,
    producedAntiClasses: ["Titan"],
    producedDamageVsStructuresMult: 1.75,
    producedSpeedMult: 1.12,
    maxCharges: 1,
    chargeCooldownSeconds: 30,
    unitAoeRadius: 2.2,
    unitFlying: true,
    producedFlavor:
      "Mechanized depot that deploys M-81A Siege Tanks — slow hover titans that crack armor and buildings with a charged cylinder beam.",
    producedUnitId: PRODUCED_UNIT_STEELBARK_M81A,
  },
  {
  ...
  },
  {
    ...
    maxCharges: 2,
    chargeCooldownSeconds: 17,
    aura: { kind: "turret", radius: 17, value: 0.42 },
    producedFlavor:
      "Defensive bastion that spawns Frostroot Keep Guards and projects a hearth ward.",
    producedUnitId: PRODUCED_UNIT_FROSTROOT_KEEP_GUARDS,
  },
  {
    id: "wooden_aerie",
    name: "Wooden Aerie",
    ...
    productionSeconds: 51,
    producedSizeClass: "Heavy",
    producedPop: 2,
    localPopCap: 12,
    maxHp: 538,
    damagePerTick: 0,
    producedAntiClasses: ["Line"],
    maxCharges: 2,
    chargeCooldownSeconds: 18,
    aura: { kind: "turret", radius: 19, value: 0.48 },
    producedFlavor:
      "Lofty forest aerie that spawns Galebark Adepts and bends the battlefield with a skyward bulwark.",
    producedUnitId: PRODUCED_UNIT_GALEBARK_ADEPTS,
  },
  {
    id: "hollowmarket_stump",
    name: "Hollowmarket Stump",
    kind: "structure",
    fluxCost: 64,
    buildSeconds: 2,
    requiredRelayTier: 1,
    ...
    producedFlavor:
      "Crowded market den that spawns Hollowmarket Cutpurses and thrives on luck, chaos, and misdirection.",
    producedUnitId: PRODUCED_UNIT_HOLLOWMARKET_CUTPURSES,
  },
  {
    id: "townwatch_keep",
    name: "Townwatch Keep",
    ...
    buildSeconds: 2,
    requiredRelayTier: 2,
    requiredSignalCounts: { Bastion: 1, Vanguard: 1 },
    signalTypes: ["Bastion", "Vanguard"],
    ...
    aura: { kind: "turret", radius: 16, value: 0.38 },
    producedFlavor:
      "Fortified town keep that raises the Town Levy and steadies nearby defenders — Call to Arms.",
    producedUnitId: PRODUCED_UNIT_TOWN_LEVY,
  },
];
