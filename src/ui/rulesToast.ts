...
const STAGES: string[] = [
  "You are a <b>Wizard</b>. <b>WASD</b> moves <b>relative to the camera</b> (W toward what you are looking at). <b>Right-click</b> sets a move goal; <b>hold right-click</b> to follow the cursor. <b>Middle mouse</b> orbits the camera.",
  ...
  "<b>Wizard melee is automatic</b> when something hostile is in arcane range. <b>R</b> arms a global rally — your next click sets where the army marches in Offense; <b>G</b> toggling stance cancels that march. Drag a tower card onto the map to summon.",
