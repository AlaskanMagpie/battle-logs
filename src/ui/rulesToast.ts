...
const STAGES: string[] = [
  ...
  "Walk into a grey <b>Mana node</b> and stay inside the ring to claim it (no click-to-claim). A physical <b>anchor pillar</b> appears with an <b>HP bar</b>; enemies can smash it to make the node <b>neutral</b> again, then contest it. Your claim grants <b>Mana/sec</b> and expands cyan <b>territory</b> (linked zones between the Keep and nodes) while the anchor stands.",
...
const MOBILE_STAGES: string[] = [
  ...
  "Walk into a grey <b>Mana node</b> and stay inside the ring to claim it. Claimed nodes grant <b>Mana/sec</b>, expand cyan <b>territory</b> (linked zones you can build in), and grow the battlefield where your doctrine can be summoned.",
  "<b>Cards drive the war</b>: drag a tower or spell from the bottom doctrine strip onto valid ground. Green/blue reads mean playable; warnings explain Mana, territory, or target problems.",
