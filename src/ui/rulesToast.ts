...
const STAGES: string[] = [
  "You are a <b>Wizard</b>. <b>WASD</b> moves <b>relative to the camera</b>. <b>Right-click</b> sets a move goal on release; <b>Shift+right-click</b> queues it. <b>Hold right-click</b> with units selected for Move / Attack / Queue / Hold orders, or with no units selected to drag-follow the Wizard. <b>Middle mouse</b> orbits the camera.",
